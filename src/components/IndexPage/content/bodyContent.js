...
The Economic and Social Inclusion Corporation is working to increase post-secondary opportunities to youth. By focusing on the 47,000 + children who are eligible for the Canada Learning Bond, we can build a better future for our children and province.
  `)
  ),
  funding: addContent(
...
*For families with more than 3 children click here.
  `)
  ),
  apply: addContent(
